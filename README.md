...
## Summary
We demonstrate a robotic dental surgeon assistant using an S0-101 arm and vision-based reasoning to retrieve and hand over medical tools. The system picks up a mirror or tweezers from both organized and unorganized tables and performs a safe handover only when a gloved dentist’s hand is detected.
